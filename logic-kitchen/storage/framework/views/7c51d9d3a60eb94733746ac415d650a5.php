...
<?php $__env->startSection('title', 'Заказать кухонный гарнитур по своим размерам недорого в Екатеринбурге - Logic Kitchen'); ?>

<?php $__env->startSection('description', 'Изготовим кухонный гарнитур по вашему проекту или же разработаем проект для вас с учётом ваших пожеланий'); ?>
...
<section class="indent light-background">
    ...
    <?php echo $__env->make('forms.gift', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</section>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Виктория\Курсы\Laravel\logic-kitchen\resources\views/home.blade.php ENDPATH**/ ?>